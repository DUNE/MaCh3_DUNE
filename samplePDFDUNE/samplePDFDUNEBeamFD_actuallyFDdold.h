#ifndef _samplePDFDUNEBeamFD_ACTUALLYFD_H_
#define _samplePDFDUNEBeamFD_ACTUALLYFD_H_
...
class samplePDFDUNEBeamFD_actuallyFD : virtual public samplePDFFDBase
{
public:
  ...
  samplePDFDUNEBeamFD_actuallyFD(std::string mc_version, covarianceXsec* xsec_cov, covarianceOsc* osc_cov);
...
protected:
  ...
  enum FuncParEnum {kTotalEScale, kTotalEScaleNotCCNumu, 
	...
	kRecoCVNNumu, kRecoCVNNue, kq0, kq3
  };
