...
Apps_DIR=/scratch/abipeake/MaCh3_DUNE_merged/MaCh3_DUNE/build/Apps/


CONFIG_YAML=/scratch/abipeake/October_chains/Tuesday_041125_enubias_newattempt_withinitialproposal/cfg/FD_Posteriorpredictive.yaml #/scratch/abipeake/October_chains/Tuesday_041125_enubias_newattempt_withinitialproposal/cfg/FD_Posteriorpredictive.yaml
...
srun "$Apps_DIR/Posteriorpreditctive_fd" "$CONFIG_YAML"
