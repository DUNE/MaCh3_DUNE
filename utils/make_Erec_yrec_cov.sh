...
ENE_MIN=0.0
ENE_MAX=10.0
EREC_MINUS_ENE_MIN=0.0
EREC_MINUS_ENE_MAX=1.10
ENE_BINS=40
EREC_MINUS_ENE_BINS=11
OUTPUT_FILE="Erecyrec_xsec_closuretest.yaml"
PARAM_LIST_FILE="Erecyrec_xsec_closuretest.txt"
